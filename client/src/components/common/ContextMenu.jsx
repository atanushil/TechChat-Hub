...
export default function ContextMenu({
  ...
  return (
    <div
      className={`bg-dropdown-background fixed  z-[100] rounded`}
      ref={contextMenuRef}
      style={{
        boxShadow:
    ...
    >
      <ul className="lg:w-[14vw] md:w-[20vw]">
        {options.map(({ name,icon, callBack }) => (
          <>
            <li
              className="hover:bg-background-default-hover text-white px-5 py-2 cursor-pointer justify-between  flex w-full items-center"
