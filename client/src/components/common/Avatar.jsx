  ...
  return (
    <>
      <div className="flex items-center justify-center">
        ...
        {type === "xl" && (
          <div
            className="relative cursor-pointer w-40 z-0"
            onMouseEnter={() => setHover(true)}
            onMouseLeave={() => setHover(false)}
            onClick={(e) => showContextMenu(e)}
          >
            <div
              className={`bg-photopicker-overlay-background h-full  w-full absolute top-[0] left-[0px] rounded-md flex items-center justify-center flex-col text-center gap-2 ${
